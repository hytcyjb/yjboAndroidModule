...
public class PagerSlidingAdd extends HorizontalScrollView {
    ...
    public PagerSlidingAdd(Context context, AttributeSet attrs, int defStyle) {
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.PagerSlidingFirst);
        mIndicatorColor = a.getColor(R.styleable.PagerSlidingFirst_pstsIndicatorColor1, mIndicatorColor);
        mIndicatorHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsIndicatorHeight1, mIndicatorHeight);
        mUnderlineColor = a.getColor(R.styleable.PagerSlidingFirst_pstsUnderlineColor1, mUnderlineColor);
        mUnderlineHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsUnderlineHeight1, mUnderlineHeight);
        mDividerColor = a.getColor(R.styleable.PagerSlidingFirst_pstsDividerColor1, mDividerColor);
        mDividerWidth = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsDividerWidth1, mDividerWidth);
        mDividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsDividerPadding1, mDividerPadding);
        isExpandTabs = a.getBoolean(R.styleable.PagerSlidingFirst_pstsShouldExpand1, isExpandTabs);
        mScrollOffset = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsScrollOffset1, mScrollOffset);
        isPaddingMiddle = a.getBoolean(R.styleable.PagerSlidingFirst_pstsPaddingMiddle1, isPaddingMiddle);
        mTabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsTabPaddingLeftRight1, mTabPadding);
        //mTabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingFirst_pstsTabBackground1, mTabBackgroundResId);
        mTabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingFirst_pstsTabTextSize1, mTabTextSize);
        mTabTextColor = a.hasValue(R.styleable.PagerSlidingFirst_pstsTabTextColor1) ? a.getColorStateList(R.styleable.PagerSlidingFirst_pstsTabTextColor1) : null;
        mTabTextTypefaceStyle = a.getInt(R.styleable.PagerSlidingFirst_pstsTabTextStyle1, mTabTextTypefaceStyle);
        isTabTextAllCaps = a.getBoolean(R.styleable.PagerSlidingFirst_pstsTabTextAllCaps1, isTabTextAllCaps);
        int tabTextAlpha = a.getInt(R.styleable.PagerSlidingFirst_pstsTabTextAlpha1, DEF_VALUE_TAB_TEXT_ALPHA);
        String fontFamily = a.getString(R.styleable.PagerSlidingFirst_pstsTabTextFontFamily1);
        a.recycle();
...
//                L.i("--select-选中---");
                tab_title.setTextColor(Color.RED);
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, mcontext.getResources().getDimension(R.dimen.text_size_20));
                TextPaint tp = tab_title.getPaint();
                tp.setFakeBoldText(true);
            }
